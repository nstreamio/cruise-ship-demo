...
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("@swim/domain"), require("@swim/util"), require("@swim/model"), require("@swim/client"), require("@swim/graphics"), require("@swim/controller"), require("@swim/panel"), require("@swim/view"), require("@swim/widget"), require("@swim/dom"), require("@swim/component"), require("@swim/uri"), require("@swim/table"), require("@swim/math"), require("@swim/theme"), require("@swim/structure")) : typeof define === "function" && define.amd ? define([ "exports", "@swim/domain", "@swim/util", "@swim/model", "@swim/client", "@swim/graphics", "@swim/controller", "@swim/panel", "@swim/view", "@swim/widget", "@swim/dom", "@swim/component", "@swim/uri", "@swim/table", "@swim/math", "@swim/theme", "@swim/structure" ], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, 
  factory((global.swim = global.swim || {}, global.swim.royalcaribbeandemo = global.swim.royalcaribbeandemo || {}), global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim, global.swim));
})(this, (function(exports, domain, util, model, client, graphics, controller, panel, view, widget, dom, component, uri, table, math, theme, structure) {
  "use strict";
  ...
  let RoomDetailsController = (() => {
    ...
    return _a = class RoomDetailsController extends widget.TimeTableController {
      constructor() {
        super();
      ...
      _infoDownlink_decorators = [ client.ValueDownlink({
        ...
        didSet(value) {
          var _a;
          if (!((_a = this.owner.panel.view) === null || _a === void 0 ? void 0 : _a.getChild("detailsContainer", dom.HtmlView))) {
