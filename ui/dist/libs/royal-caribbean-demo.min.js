...
(function(global, factory) {
  ...
  let RoomController = (() => {
    ...
    return _a = class RoomController extends _classSuper {
      ...
      updateCellsContent(occupancyDetected, hvacTemp) {
        ...
        didLink() {
          this.owner.intervalId = window.setInterval((() => {
            ...
            if (this.opened && ((_b = this === null || this === void 0 ? void 0 : this.get) === null || _b === void 0 ? void 0 : _b.call(this))) {
              this.owner.updateCellsContent(this.get().get("occupancyDetected").numberValue(0), this.get().get("hvacTemperature").numberValue(0));
            }
      ...
      _deckSavings_decorators = [ component.Property({
        ...
        didSetValue(newValue = 0, oldValue = 0) {
          ...
          if (savingsTimeTextEl) {
            savingsTimeTextEl.innerText = `${this.owner.getTimeText(newValue)} spent in EcoMode`;
          }
      ...
      _content_decorators = [ view.ViewRef({
        ...
        createView() {
          ...
          const pTimeView = new dom.HtmlView(document.createElement("p")).set({
            ...
            text: `${this.owner.getTimeText(this.owner.deckSavings.value)} spent in EcoMode`
          });
  ...
  let DeckBoardController = (() => {
    ...
    return _a = class DeckBoardController extends _classSuper {
      ...
      initBoard() {
        ...
        const ecoModeColumnPanelView = ecoModeColumnController.panel.insertView(rootPanelView).set({
          unitWidth: 1 / 2,
          unitHeight: 1
        });
