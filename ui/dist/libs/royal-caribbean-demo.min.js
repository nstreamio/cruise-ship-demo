...
(function(global, factory) {
  ...
  let RoomController = (() => {
    ...
    return _a = class RoomController extends _classSuper {
      ...
      updateCellsMood() {
        let moodStatus = _a.RoomStatusMood.get(this.ecoMode ? RoomStatus.ecoMode : RoomStatus.recentlyOccupied);
        this.deckCell.attachView().modifyMood(theme.Feel.default, moodStatus.moodModifier);
        this.roomCell.attachView().modifyMood(theme.Feel.default, moodStatus.moodModifier);
        this.hvacTempCell.attachView().modifyMood(theme.Feel.default, moodStatus.moodModifier);
        this.timeSinceOccupiedCell.attachView().modifyMood(theme.Feel.default, moodStatus.moodModifier);
      }
    }, (() => {
      var _b;
      const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_b = _classSuper[Symbol.metadata]) !== null && _b !== void 0 ? _b : null) : void 0;
      ...
      _statusDownlink_decorators = [ client.ValueDownlink({
        ...
        didSet(value) {
          ...
          this.owner.timeSinceOccupiedCell.attachView().set({
            content: content,
