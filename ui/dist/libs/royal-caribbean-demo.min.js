  ...
  let RoomController = (() => {
    ...
    return _a = class RoomController extends _classSuper {
      constructor(nodeUri, ecoMode) {
        ...
        this.setKey(nodeUri);
        const regexResult = (_b = /\/ship\/\w+\/deck\/(\d+)\/room\/(\d+)/.exec(nodeUri)) !== null && _b !== void 0 ? _b : [ null, "", "" ];
