...
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("@swim/domain"), require("@swim/util"), require("@swim/model"), require("@swim/client"), require("@swim/graphics"), require("@swim/controller"), require("@swim/panel"), require("@swim/uri"), require("@swim/component"), require("@swim/structure"), require("@swim/theme"), require("@swim/view"), require("@swim/table"), require("@swim/widget"), require("@swim/math"), require("@swim/style"), require("@swim/time"), require("@swim/chart"), require("@swim/pie"), require("@swim/dom")) : typeof define === "function" && define.amd ? define([ "exports", "@swim/domain", "@swim/util", "@swim/model", "@swim/client", "@swim/graphics", "@swim/controller", "@swim/panel", "@swim/uri", "@swim/component", "@swim/structure", "@swim/theme", "@swim/view", "@swim/table", "@swim/widget", "@swim/math", "@swim/style", "@swim/time", "@swim/chart", "@swim/pie", "@swim/dom" ], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, 
...
})(this, (function(exports, domain, util, model, client, graphics, controller, panel, uri, component, structure, theme, view, table, widget, math, style, time, chart, pie, dom) {
  "use strict";
  ...
  let RoomController = (() => {
    ...
    return _a = class RoomController extends widget.TimeSeriesController {
      ...
      updateOrder(orderId) {
        const idx = RoomController.orderStatusProgression.indexOf(this.eventKey);
        const newStatus = RoomController.orderStatusProgression[idx + 1];
      ...
      _stats_decorators = [ component.Property({
        ...
        didSetValue(value) {
          var _a, _b, _c, _d;
          let moodStatus = RoomController.orderStatusMood.get(this.owner.eventKey);
  ...
  let RoomListController = (() => {
    ...
    return _a = class RoomListController extends widget.TimeTableController {
      constructor(key) {
        ...
        this.setKey(`RoomListController-${key}`);
        this.eventKey = key;
      }
      static parseStoreStatus(v) {
        return [ OrderStatus.orderPlaced, OrderStatus.orderProcessed, OrderStatus.readyForPickup, OrderStatus.pickupCompleted ].reduce(((acc, s) => {
          [ OrderType.OrderA, OrderType.OrderB, OrderType.OrderC ].forEach((t => {
            ...
            let value = count * RoomListController.valuePerOrderType[t];
            if (!acc[s]) {
              acc[s] = {
                total: {
                  count: 0,
      ...
      _orderDownlink_decorators = [ client.MapDownlink({
        ...
        didUpdate(nodeUri, value) {
          ...
          if (roomController === null && this.owner.eventKey === orderStatus) {
            roomController = new RoomController(nodeUri.toString(), this.owner.eventKey);
            roomController.leaf.insertView().set({
              style: {
                cursor: "pointer"
              }
            });
            roomController.customerCell.insertView();
            roomController.orderCell.insertView();
            roomController.timeInProcessingCell.insertView();
            const customerId = value.get("customerId").stringValue();
            if (customerId === "Customer0") {
              console.log("found Customer0 in RoomListController");
              roomController.pinned.setValue(true);
            }
      ...
      _mainStatusDownlink_decorators = [ client.ValueDownlink({
        ...
        consumed: true,
        didSet(value) {
          const storeStatus = RoomListController.parseStoreStatus(value);
          [ OrderType.OrderA, OrderType.OrderB, OrderType.OrderC ].forEach((t => {
  ...
  let DeckController = (() => {
    ...
    let _entity_decorators;
    let _entity_initializers = [];
    return _a = class DeckController extends panel.BoardController {
      constructor() {
        super();
        this.sheet = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _sheet_initializers, void 0));
        this.entity = __runInitializers(this, _entity_initializers, void 0);
      ...
      initBoard() {
        ...
        const orderPlacedListController = orderPlacedPanelController.appendChild(new RoomListController(OrderStatus.orderPlaced), `List${OrderStatus.orderPlaced}`);
        ...
        const orderProcessedListController = orderProcessedPanelController.appendChild(new RoomListController(OrderStatus.orderProcessed), `List${OrderStatus.orderProcessed}`);
        ...
        const orderReadyListController = orderReadyPanelController.appendChild(new RoomListController(OrderStatus.readyForPickup), `List${OrderStatus.readyForPickup}`);
  ...
  let ShipEntityTrait = (() => {
    ...
    return _a = class ShipEntityTrait extends domain.EntityTrait {
      constructor() {
        ...
        this.title.setIntrinsic("Icon of the Seas");
      }
    }, (() => {
      _portal_decorators = [ model.TraitModelRef({
        modelType: model.Model,
